...
if (isset($_POST['simpan'])) {
    ...
    if (move_uploaded_file($tmp_name, $folder)) {
        mysqli_query($conn, "INSERT INTO produk (nama_makanan, harga, gambar) VALUES ('$nama', '$harga', '$filename')");
...
<div class="content">
    <div class="mb-4">
        ...
        <p class="text-muted">Masukkan detail makanan untuk ditambahkan ke katalog.</p>
    </div>
    ...
    <div class="form-container">
        <form method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" name="nama_makanan" class="form-control" placeholder="Contoh: Nasi Goreng Spesial" required>
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="submit" name="simpan" class="btn btn-primary px-4"><i class="fas fa-save me-2"></i>Simpan Menu</button>
